...
class GeneralInformationController(
    ...
    override suspend fun createGeneralInformation(request: CreateGeneralInformationRequest): GeneralInformationListItemResponse =
        GeneralInformationListItemResponse(generalInformationFacade.createGeneralInformation(request))
}